<fieldset>
    ...
    <input type="number" id="precio" name="propiedad[precio]" min="1" max="10000000" placeholder="Precio Propiedad" value="<?php echo s($propiedad->precio); ?>">
...
<fieldset>
    ...
    <input type="number" id="habitacion" name="propiedad[habitacion]" placeholder="Ej: 3" min="1" max="9" value="<?php echo s($propiedad->habitacion); ?>">
